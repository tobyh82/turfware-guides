...
A user's access is set on their user record (Users → User Management → open a user), and it's made up of three independent parts. There are no per-screen access toggles — you set these three things and Turfware handles the rest.

- **Web Portal Access** — one level that controls whether, and how much, the user can do in the web app: Admin, Super User, User or Carrier. Leave it unselected for someone who only needs a field app.
