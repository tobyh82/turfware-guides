...
- **Pallet Spaces** — used / capacity (e.g. `5 / 116`).
- **Drops** — used / capacity (e.g. `2 / 100`).
...
!!! note "Calendar layout — across all of Turfware"
    Every calendar in Turfware uses a clean **Monday–Sunday** layout, with **weekends lightly greyed** so they're easy to pick out at a glance when you're moving quickly.
