...
Change the order's Status from Pending → Confirmed (top-right of the order). Depending on your admin settings there may be a payment blocker — see [Creating & Managing an Order](creating-and-managing-an-order.md#moving-the-order-through-the-workflow) for the *Require Payment Before Confirmation* rule and how confirmation works.
