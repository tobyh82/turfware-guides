...
If the service is sold online, link it to its matching **Shopify item**. See the **Processing Shopify Orders** guide.

!!! note "No volume pricing on services"
    Volume pricing applies to turf and products only — services are priced per the rate above.
